...
void ui_Screen11_screen_init(void) {
    ...
    lv_obj_set_style_text_color(ui_Screen11_Status_Label, lv_color_hex(CLR_TEXT_WHITE), 0);
    lv_obj_set_style_text_font(ui_Screen11_Status_Label, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_text_color(ui_Screen11_Progress_Label, lv_color_hex(CLR_TEXT_DIM), 0);
    lv_obj_set_style_text_font(ui_Screen11_Progress_Label, &lv_font_montserrat_14, 0);
    ...
    lv_obj_set_style_bg_color(ui_Screen11_Progress_Bar, lv_color_hex(0x1F293B), LV_PART_MAIN);
    lv_obj_set_style_bg_color(ui_Screen11_Progress_Bar, lv_color_hex(CLR_CYAN), LV_PART_INDICATOR);
    ...
    lv_obj_set_style_bg_color(ui_Screen11_Logs_Textarea, lv_color_hex(0x05070C), 0);
    lv_obj_set_style_bg_opa(ui_Screen11_Logs_Textarea, LV_OPA_COVER, 0);
    lv_obj_set_style_text_color(ui_Screen11_Logs_Textarea, lv_color_hex(CLR_GREEN), 0);
    lv_obj_set_style_text_font(ui_Screen11_Logs_Textarea, &lv_font_montserrat_12, 0);
    ...
    // Hide cursor styling
    lv_obj_set_style_bg_opa(ui_Screen11_Logs_Textarea, LV_OPA_TRANSP, LV_PART_CURSOR);
    lv_obj_set_style_border_opa(ui_Screen11_Logs_Textarea, LV_OPA_TRANSP, LV_PART_CURSOR);

    lv_textarea_set_cursor_click_pos(ui_Screen11_Logs_Textarea, false);
    lv_textarea_set_placeholder_text(ui_Screen11_Logs_Textarea, "Scanner terminal logs will appear here...\nConnect the device to the Powertrain CAN bus and click 'AUTO SCAN'.");
    ...
    lv_obj_set_style_bg_color(clear_btn, lv_color_hex(0xE76F51), 0); // Warm orange/coral
    ...
    lv_obj_add_event_cb(clear_logs_btn, clear_logs_btn_cb, LV_EVENT_CLICKED, NULL);
...
void ui_Screen11_update(void) {
    ...
    if (ui_Screen11_Status_Label) {
        switch (state) {
            ...
            case TESTER_SCANNING:
                lv_label_set_text(ui_Screen11_Status_Label, "STATUS: SCANNING POWERTRAIN BUS...");
                lv_obj_set_style_text_color(ui_Screen11_Status_Label, lv_color_hex(CLR_GOLD), 0);
                break;
            case TESTER_CLEARING:
                lv_label_set_text(ui_Screen11_Status_Label, "STATUS: CLEARING FAULT CODES...");
                lv_obj_set_style_text_color(ui_Screen11_Status_Label, lv_color_hex(0xE76F51), 0);
                break;
            case TESTER_FINISHED:
                lv_label_set_text(ui_Screen11_Status_Label, "STATUS: COMPLETED");
                lv_obj_set_style_text_color(ui_Screen11_Status_Label, lv_color_hex(CLR_GREEN), 0);
                break;
        }
    }
    ...
    if (ui_Screen11_Logs_Textarea) {
        ...
        if (strcmp(last_logs, logs) != 0) {
            ...
            lv_textarea_set_cursor_pos(ui_Screen11_Logs_Textarea, LV_TEXTAREA_CURSOR_LAST);
