...
static const char *SYSTEM_PROMPT =
    ...
    "5-Момент, 6-Настройки и Lua терминал, 7-Open Claw AI терминал, 8-Classic Sports Dashboard, "
    "9-Air to Water Intercooler Controls, 10-Wastegate и Blow-off управление (LDR/LDUVST стратегия, "
    "VGT servo wastegate позиция, соленоид blow-off, 10-точечные RPM-карты, триггеры overboost и TPS-drop), "
    "11-VAG Диагностический Сканер (Auto Scan, чтение/очистка ошибок DTC, UDS over ISO-TP), "
    "12-VAG Launch Control Диагностика (состояние лаунч-контроля DSG, 5 условий активации: "
    "селектор Sport, скорость=0, педаль газа, тормоз, TCU торк-интервенция). "
...
static const char *FUNCTION_DECLARATIONS =
    ...
    "экрана от 1 до 12: 1-Главный, 2-Датчики, 3-CAN, 4-Доп, 5-Момент, "
    "6-Настройки/Lua, 7-AI, 8-Sport, 9-Intercooler, 10-Wastegate/BOV, 11-Диагностика, 12-Лаунч\"}"
    "    },"
